	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xs-12 col-md-6">
				...
				<form class="contact-form row" method="post" action="https://html.modernwebtemplates.com/qtyler/">
					<div class="col-xs-12">
				...
				<ul class="list1 no-bullets">
					...
					<li>
						<div class="media teaser media-icon-teaser">
							...
							<div class="media-body media-middle">
								<h3>Email</h3>
								<p><a href="https://html.modernwebtemplates.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c7b6b3beaba2b587a2bfa6aab7aba2e9a4a8aa">[email&#160;protected]</a></p>
							</div>
						</div>
					</li>
					<li>
