...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
					...
					<div class="row flex-wrap v-center">
						<div class="col-xs-12 col-md-8 text-center text-md-left">
							<div class="inline-content big-spacing"> <span>
									...
									<a href="abc@gmail.com" class="__cf_email__" data-cfemail="9dece9e4f1f8efddf8e5fcf0edf1f8b3fef2f0">abc@gmail.com</a>
								</span> <span>
							...
							<div class="header_mainmenu text-center">
								...
								<nav class="mainmenu_wrapper">
									<ul class="mainmenu nav sf-menu">
										...
										<li> <a href="<?php echo base_url() ?>Buying_house/about">About</a> </li>
										<li> <a href="<?php echo base_url() ?>Buying_house/gallery">Gallary</a> </li>
										<li> <a href="<?php echo base_url() ?>Buying_house/faq">FAQ</a></li>
										<li> <a href="<?php echo base_url() ?>Buying_house/products">Products</a></li>
										<li> <a href="<?php echo base_url() ?>Buying_house/blog">Blog</a></li>
										<li> <a href="<?php echo base_url() ?>Buying_house/contact">Contact</a></li>
									</ul>
								</nav>
								<!-- eof main nav -->
			...
			<section class="ls ms section_404 section_padding_top_150 section_padding_bottom_150">
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-md-offset-3 text-center">
							...
							<div class="widget widget_search">
								<form method="get" class="searchform" action="https://html.modernwebtemplates.com/qtyler/">
							...
							<p> or </p>
							<p> <a href="index-2.html" class="theme_button min_width_button">Go to homepage</a> </p>
						</div>
					</div>
				</div>
			</section>
